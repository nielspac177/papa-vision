...
> (ES, 19 slides). The Spanish manuscript reuses the same auto-generated metric
...
├── slides/             # Marp presentation decks (EN: presentation.md · ES: presentacion.md, 19 slides)
